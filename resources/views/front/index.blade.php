...
<html lang="en">
    ...
    <body class="mx-auto max-w-[640px] bg-white">
                        ...
                        @forelse ($popularTickets as $popularTicket)
                            <li class="swiper-slide !w-fit">
                                ...
                                >
                                    ...
                                    >
                                        <img
                                            src="{{ Storage::url($popularTicket->thumbnail) }}"
                    ...
                    <ul class="swiper-wrapper">
                        @forelse ($categories as $category)
                            <li class="swiper-slide !w-fit">
                                ...
                                >
                                    <div
                                        class="flex w-fit items-center gap-[10px] text-nowrap rounded-full bg-[#F8F8F9] p-[14px_20px]"
                                    >
                                        <img
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <img
                                                src="{{ Storage::url($newTicket->thumbnail) }}"
                                        ...
                                        >
                                            ...
                                            >
                                                Rp
                                                {{ number_format($newTicket->price, 0, ",", ".") }}
                                            </span>
                                        </div>
                                    </div>
        ...
        <nav
            class="fixed bottom-0 z-10 w-full max-w-[640px] bg-white px-4 py-5"
        >
            <ul class="flex justify-evenly max-[400px]:justify-between">
                <li class="text-[#F97316]">
                    ...
                    >
                        <div
                            class="group flex flex-col items-center gap-[10px] text-center"
                        >
                            <div class="flex h-6 w-6 shrink-0">
                                <svg
                                    class="fill-current transition-all duration-300 group-hover:fill-[#F97316]"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    fill="none"
                            ...
                            <span
                                class="text-sm font-semibold text-current transition-all duration-300 group-hover:text-[#F97316]"
                            >
                                Discover
                            </span>
                        </div>
                ...
                <li class="text-[#13181D]">
                    <a href="#" aria-label="View rewards">
                        <div
                            class="group flex flex-col items-center gap-[10px] text-center"
                        >
                            <div class="flex h-6 w-6 shrink-0">
                ...
                <li class="text-[#13181D]">
                    <a href="#" aria-label="View support">
                        <div
                            class="group flex flex-col items-center gap-[10px] text-center"
                        >
                            <div class="flex h-6 w-6 shrink-0">
